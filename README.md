...
- **Latency Compensation**: A fixed +1 s offset is applied when storing time from both WWVB and NTP to compensate for ES100 frame processing delay, radio propagation, and display loop latency. Measured accuracy vs. NIST time.gov is approximately ±364 ms.
